...
| Range | Status |
| --- | --- |
| `SPEC-SND-001` .. `SPEC-SND-009` | In use |
| `SPEC-RCV-001` .. `SPEC-RCV-005` | In use |
| `SPEC-SRCH-001` .. `SPEC-SRCH-006` | In use |
| `SPEC-SYNC-001` .. `SPEC-SYNC-007` | In use |
| `SPEC-PSN-001` .. `SPEC-PSN-009` | In use |
| `SPEC-SEC-001` .. `SPEC-SEC-012` | In use |
| `SPEC-LIM-001` .. `SPEC-LIM-007` | In use |
| `ADR-0000` .. `ADR-0011` | In use (`0000` is the template) |
| `RISK-01` .. `RISK-12` | In use |
| `TASK-001` .. `TASK-017` | In use |
